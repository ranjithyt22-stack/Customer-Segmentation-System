...
def generate_interactive_dashboard(rfm):
    ...
    pio.write_html(fig1, file="static/cluster_plot_interactive.html", auto_open=False, include_plotlyjs="directory")
    ...
    pio.write_html(fig2, file="static/segment_pie_interactive.html", auto_open=False, include_plotlyjs="directory")
    ...
    pio.write_html(fig3, file="static/avg_spending_interactive.html", auto_open=False, include_plotlyjs="directory")
